...
public class AuditServiceImpl implements AuditService {
    ...
    @Override
    public Page<AuditDTO> pagingQuery(Long userId, String businessType, String dataType, int page,int size) {
        return PageHelper.startPage(page,size).doSelectPage(()->auditMapper.selectByParams(userId, businessType, dataType));
    }
}
