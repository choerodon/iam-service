 ...
 */
@RestController
@RequestMapping(value = "/v1/role_members")
public class RoleMemberController extends BaseController {
    ...
    @PostMapping(value = "/organization_level")
    ...
    @PostMapping(value = "/site_level/delete")
    ...
    @PostMapping(value = "/organization_level/delete")
    ...
    @PostMapping(value = "/project_level/delete")
