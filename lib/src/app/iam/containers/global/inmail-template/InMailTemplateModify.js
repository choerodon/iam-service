...
var InMailTemplateModify = (_dec = _form2['default'].create(), _dec2 = (0, _mobxReact.inject)('AppState'), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  (0, _inherits3['default'])(InMailTemplateModify, _Component);

  function InMailTemplateModify() {
    var _ref;

    var _temp, _this, _ret;

    (0, _classCallCheck3['default'])(this, InMailTemplateModify);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = InMailTemplateModify.__proto__ || Object.getPrototypeOf(InMailTemplateModify)).call.apply(_ref, [this].concat(args))), _this), _this.state = _this.getInitState(), _this.loadDetail = function () {
      _inmailTemplate2['default'].getTemplateDetail(_this.state.id, _this.mail.type, _this.mail.orgId).then(function (data) {
        if (data.failed) {
      ...
      var body = (0, _extends3['default'])({}, values, {
        ...
        id: _inmailTemplate2['default'].getCurrentDetail.id,
        isPredefined: _inmailTemplate2['default'].getCurrentDetail.isPredefined,
        objectVersionNumber: _inmailTemplate2['default'].getCurrentDetail.objectVersionNumber
      });

      _inmailTemplate2['default'].updateTemplateDetail(_inmailTemplate2['default'].getCurrentDetail.id, body, type, orgId).then(function (data) {
        if (data.failed) {
          Choerodon.prompt(data.message);
        } else {
      ...
      var tip = _react2['default'].createElement(
        ...
        _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'inmailtemplate.mailcontent.tip' }),
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          getFieldDecorator('code', {
            ...
            initialValue: _inmailTemplate2['default'].getCurrentDetail.code
          })(_react2['default'].createElement(_input2['default'], { disabled: true, autoComplete: 'off', style: { width: inputWidth }, label: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'inmailtemplate.code' }) }))
        ),
        _react2['default'].createElement(
          FormItem,
          formItemLayout,
          getFieldDecorator('name', {
            ...
            initialValue: _inmailTemplate2['default'].getCurrentDetail.name
          })(_react2['default'].createElement(_input2['default'], { disabled: true, autoComplete: 'off', style: { width: inputWidth }, label: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'inmailtemplate.name' }) }))
        ),
        _react2['default'].createElement(
          FormItem,
          formItemLayout,
          getFieldDecorator('type', {
            ...
            initialValue: _inmailTemplate2['default'].getCurrentDetail.type
          })(_react2['default'].createElement(
            _select2['default'],
            {
        ...
        _react2['default'].createElement(
          ...
          getFieldDecorator('title', {
            ...
            initialValue: _inmailTemplate2['default'].getCurrentDetail.title
  ...
  (0, _createClass3['default'])(InMailTemplateModify, [{
    key: 'getInitState',
    ...
    value: function componentWillMount() {
      ...
      if (!_inmailTemplate2['default'].getCurrentDetail.type) {
        this.loadDetail();
      }
    }
  }, {
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_choerodonBootCombine.Header, {
          title: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'inmailtemplate.modify' }),
        ...
        _react2['default'].createElement(
          _choerodonBootCombine.Content,
          {
            ...
            values: { name: _inmailTemplate2['default'].getCurrentDetail.code }
          },
          this.renderContent()
        )
      );
  ...
  return InMailTemplateModify;
}(_react.Component)) || _class) || _class) || _class) || _class) || _class);
exports['default'] = InMailTemplateModify;