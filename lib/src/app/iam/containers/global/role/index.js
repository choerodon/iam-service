...
var index = (0, _choerodonBootCombine.asyncRouter)(function () {
  ...
  return import('../../../stores/global/role');
});
var edit = (0, _choerodonBootCombine.asyncRouter)(function () {
  return import('./RoleEdit');
}, function () {
  return import('../../../stores/global/role');
});
var create = (0, _choerodonBootCombine.asyncRouter)(function () {
  return import('./RoleCreate');
}, function () {
  return import('../../../stores/global/role');
});
...
var Index = function Index(_ref) {
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(_reactRouterDom.Route, { path: match.url + '/edit/:id', component: edit }),
