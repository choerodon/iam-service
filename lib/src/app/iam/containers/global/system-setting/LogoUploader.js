...
var _SystemSettingStore = require('../../../stores/global/system-setting/SystemSettingStore');

var _SystemSettingStore2 = _interopRequireDefault(_SystemSettingStore);

require('../../user/user-info/Userinfo.scss');
...
var minRectSize = 80;
var intlPrefix = 'global.system-setting.edit';
var prefixClas = 'c7n-iam-system-setting-edit';
var limitSize = 1024;
var relativeX = 0;
var relativeY = 0;
...
var AvatarUploader = (_dec = (0, _mobxReact.inject)('AppState'), _dec(_class = (0, _reactIntl.injectIntl)(_class = function (_Component) {
  ...
  function AvatarUploader() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = AvatarUploader.__proto__ || Object.getPrototypeOf(AvatarUploader)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _choerodonBootCombine.axios.post(Choerodon.API_HOST + '/iam/v1/system/setting/upload/logo?' + qs, data).then(function (res) {
        if (res.failed) {
  ...
  (0, _createClass3['default'])(AvatarUploader, [{
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(_button2['default'], { icon: 'replay_90', shape: 'circle', onClick: function onClick() {
                return _this3.initImageSize(img, rotate - 90);
              } }),
      ...
      return {
        ...
        beforeUpload: function beforeUpload(file) {
          ...
          if (windowURL && windowURL.createObjectURL) {
            _this4.loadImage(windowURL.createObjectURL(file));
            return false;
          }
        },
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        _modal2['default'],
        {
          title: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: intlPrefix + '.title', values: { name: type === 'favicon' ? '徽标' : '导航栏图形标' } }),
