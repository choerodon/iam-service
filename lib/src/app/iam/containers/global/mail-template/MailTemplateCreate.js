...
var MailTemplateCreate = (_dec = _form2['default'].create(), _dec2 = (0, _mobxReact.inject)('AppState'), _dec(_class = (0, _reactRouterDom.withRouter)(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  (0, _inherits3['default'])(MailTemplateCreate, _Component);
  ...
  function MailTemplateCreate() {
    ...
    (0, _classCallCheck3['default'])(this, MailTemplateCreate);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = MailTemplateCreate.__proto__ || Object.getPrototypeOf(MailTemplateCreate)).call.apply(_ref, [this].concat(args))), _this), _this.state = _this.getInitState(), _this.loadTemplateType = function () {
      ...
      _choerodonBootCombine.axios.post('notify/v1/notices/emails/templates/check', value).then(function (mes) {
        if (mes.failed) {
      ...
      _mailTemplate2['default'].createTemplate(body, type, orgId).then(function (data) {
        if (data.failed) {
          Choerodon.prompt(data.message);
        } else {
      ...
      var selectType = _mailTemplate2['default'].selectType;
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          getFieldDecorator('code', {
            ...
            validateFirst: true
          })(_react2['default'].createElement(_input2['default'], { autoComplete: 'off', style: { width: inputWidth }, label: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'mailtemplate.code' }) }))
        ),
        _react2['default'].createElement(
          FormItem,
          formItemLayout,
          ...
          })(_react2['default'].createElement(_input2['default'], { autoComplete: 'off', style: { width: inputWidth }, label: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'mailtemplate.name' }) }))
        ),
        _react2['default'].createElement(
          FormItem,
          formItemLayout,
          getFieldDecorator('type', {
            ...
            initialValue: _mailTemplate2['default'].getCurrentDetail.type || undefined
          })(_react2['default'].createElement(
            _select2['default'],
            {
        ...
        _react2['default'].createElement(
          ...
          getFieldDecorator('title', {
            ...
            initialValue: _mailTemplate2['default'].getCurrentDetail.title || undefined
  ...
  (0, _createClass3['default'])(MailTemplateCreate, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_choerodonBootCombine.Header, {
          title: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'mailtemplate.create' }),
  ...
  return MailTemplateCreate;
}(_react.Component)) || _class) || _class) || _class) || _class) || _class);
exports['default'] = MailTemplateCreate;