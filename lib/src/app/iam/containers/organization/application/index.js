...
var index = (0, _choerodonBootCombine.asyncRouter)(function () {
  ...
  return import('../../../stores/organization/application');
});
var manageApplication = (0, _choerodonBootCombine.asyncRouter)(function () {
  return import('./ManageApplication');
}, function () {
  return import('../../../stores/organization/application');
});
...
var Index = function Index(_ref) {
  ...
  return _react2['default'].createElement(
    ...
    _react2['default'].createElement(_reactRouterDom.Route, { exact: true, path: match.url + '/manage/:applicationId', component: manageApplication }),
