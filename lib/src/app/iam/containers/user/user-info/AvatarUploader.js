...
var minRectSize = 80;
var intlPrefix = 'user.userinfo.avatar.edit';
var prefixClas = 'user-info-avatar-edit';
var limitSize = 1024;
var relativeX = 0;
var relativeY = 0;
...
var AvatarUploader = (_dec = (0, _mobxReact.inject)('AppState'), _dec(_class = (0, _reactIntl.injectIntl)(_class = function (_Component) {
  ...
  function AvatarUploader() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = AvatarUploader.__proto__ || Object.getPrototypeOf(AvatarUploader)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _choerodonBootCombine.axios.post('/iam/v1/users/' + id + '/save_photo?' + qs, data).then(function (res) {
        if (res.failed) {
          Choerodon.prompt(res.message);
        } else {
          AppState.loadUserInfo().then(function (info) {
            _UserInfoStore2['default'].setUserInfo(info);
