...
var index = (0, _choerodonBootCombine.asyncRouter)(function () {
  return import('./OrganizationInfo');
}, {
  OrganizationInfoStore: function OrganizationInfoStore() {
    return import('../../../stores/user/organization-info');
  },
  PermissionInfoStore: function PermissionInfoStore() {
    return import('../../../stores/user/permission-info');
  }
});
