...
databaseChangeLog(logicalFilePath: 'script/db/iam_menu_b.groovy') {
    changeSet(author: 'guokai.wu.work@gmail.com', id: '2018-03-29-iam-menu-b') {
        ...
        addUniqueConstraint(tableName: 'IAM_MENU_B', columnNames: 'CODE, TYPE, LEVEL', constraintName: 'UK_IAM_MENU_B_U1')
    }
    ...
    changeSet(author: 'superleader8@gmail.com', id: '2018-08-28-rename') {
        renameColumn(columnDataType: 'VARCHAR(64)', newColumnName: "FD_LEVEL", oldColumnName: "LEVEL", remarks: '菜单层级', tableName: 'IAM_MENU_B')
    }
    ...
    changeSet(author: 'superlee', id: '2019-04-14-rename') {
        dropTable(tableName: 'IAM_MENU_TL')
        dropColumn(tableName: 'IAM_MENU_B', columnName: 'ROUTE')
        renameColumn(columnDataType: 'VARCHAR(64)', newColumnName: "RESOURCE_LEVEL", oldColumnName: "FD_LEVEL", remarks: '菜单层级', tableName: 'IAM_MENU_B')
        addColumn(tableName: 'IAM_MENU_B') {
